...
export interface AppNotification {
  ...
  read: boolean;
  createdAt: any; // Can be Date or Firebase Timestamp
  readAt?: any; // Can be Date or Firebase Timestamp
  audience?: 'all' | 'resident' | 'admin' | 'specific';
  targetType?: 'all' | 'specific' | 'resident' | 'admin';
  totalRecipients?: number;
  sentBy?: string; // ID del usuario que envió la notificación
}
