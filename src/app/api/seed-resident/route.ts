...
export async function GET(req: Request) {
  try {
    ...
    const password = url.searchParams.get("password") || "Residente123!";
    ...
    return NextResponse.json({
      ok: true,
      message: `Residente ${fullName} creado con email ${email} y contraseña ${password}, vehículo creado y ${spotId} asignado.`,
