...
export function ResidentForm({ onResidentCreated }: ResidentFormProps) {
  ...
  const onSubmit = async (data: ResidentFormValues) => {
    ...
    // Estructurar los datos para coincidir con el schema de manage-residents
    const residentData = {
      email: data.email,
    ...
    if (result.ok) {
      // Construct the ResidentData from the form data
      const newResident: ResidentData = {
        ...
        interiorNumber: data.interiorNumber,
        houseNumber: data.houseNumber,
        vehicleCount: data.licensePlate ? 1 : 0,
        vehicles: data.licensePlate || '',
      };
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)}>
            <DialogHeader>
              ...
              <DialogDescription>
                Completa el formulario para registrar un nuevo residente y opcionalmente su vehículo. Establece una contraseña para que el residente pueda iniciar sesión.
              </DialogDescription>
            </DialogHeader>
            ...
            <div className="space-y-4 py-4">
                ...
                <FormField
                    ...
                    <FormItem>
                        ...
                        <FormControl>
                        <Input type="password" placeholder="Contraseña para el residente" {...field} />
                        </FormControl>
                        <FormMessage />
                    </FormItem>
                    )}
